...
<script>
     (adsbygoogle = window.adsbygoogle || []).push({
          google_ad_client: "ca-pub-6536927189719688",
          enable_page_level_ads: true
     });
</script>
    <meta charset=utf-8>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="google-site-verification" content="mb5UAizp52GF6-_w8XAirXoXIHlD2zdg94pFe0_x6Co" />
    ...
    <script type="text/javascript">function add_chatinline(){var hccid=93432213;var nt=document.createElement("script");nt.async=true;nt.src="https://mylivechat.com/chatinline.aspx?hccid="+hccid;var ct=document.getElementsByTagName("script")[0];ct.parentNode.insertBefore(nt,ct);}
            ...
            <div class="container">
                ...
                <div class="nav-collapse collapse pull-right">
                    <ul class="nav" id="top-navigation">
						...
						<!-- <li ><a href="#" target="_blank" style="background-color:Red;">Find a Job</a></li> -->
                    </ul>
        ...
        <div id="da-slider" class="da-slider">
            ...
            <div class="container">
                ...
                <div class="da-slide">
                    ...
                    <p>Find the Right Contractors! You may not be able to afford or need a full-time (personnel), and it is easier to change to an outsourced provider with the  
					right skill set as your needs change. </p>
                ...
                <div class="da-slide">
					...
					as your business grows: Chartered Accountants, Lawyers and others. </p>
                    <a href="post" class="da-link button">Post Your Project Here!</a>
                    <div class="da-img">
                ...
                <!-- Start third slide -->
                <div class="da-slide">
                    <h2>Do you Need an Expert Input on a Project?</h2>
                    <h4>Find Skilled Personnel Worldwide Ready To Assist!</h4>
            ...
            <div class="row-fluid">
                ...
                <div class="span3">
                    <div class="centered service">
                        ...
                        <h3> Management</h3>
                        <p>Process of dealing with or controlling things of people</p>
                    </div>
                </div>
            </div>
